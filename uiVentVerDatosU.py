...
class uiVerD(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.setMinimumSize(QtCore.QSize(1070, 509))
        mainWindow.setMaximumSize(QtCore.QSize(1070, 509))
        ...
        self.frame.setMinimumSize(QtCore.QSize(1091, 511))
        self.frame.setMaximumSize(QtCore.QSize(1091, 511))
        ...
        self.frame_2.setGeometry(QtCore.QRect(-10, -20, 1091, 101))
        ...
        self.label_9.setGeometry(QtCore.QRect(470, 40, 170, 41))
        font = QtGui.QFont()
        font.setFamily("Chewy")
        ...
        self.label_datosProfesion = QtWidgets.QLabel(self.frame)
        self.label_datosProfesion.setGeometry(QtCore.QRect(770, 90, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Chewy")
        font.setPointSize(16)
        font.setBold(False)
        ...
        self.label_datosProfesion.setFont(font)
        self.label_datosProfesion.setStyleSheet("background-color: rgb(79, 163, 166);\n"
                                    "border-radius: 10px;")
        self.label_datosProfesion.setAlignment(QtCore.Qt.AlignCenter)
        self.label_datosProfesion.setObjectName("label_datosProfesion")
        ...
        self.labelCargo.setGeometry(QtCore.QRect(775, 170, 260, 41))
        font = QtGui.QFont()
        font.setFamily("Chewy")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.labelCargo.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.labelCargo.setStyleSheet("border: 2px solid #4FA3A6;")
        ...
        self.labelExperiencia = QtWidgets.QLabel(self.frame)
        self.labelExperiencia.setGeometry(QtCore.QRect(775, 253, 260, 41))
        font = QtGui.QFont()
        font.setFamily("Chewy")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.labelExperiencia.setFont(font)
        self.labelExperiencia.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.labelExperiencia.setStyleSheet("border: 2px solid #4FA3A6;")
        self.labelExperiencia.setAlignment(QtCore.Qt.AlignCenter)
        self.labelExperiencia.setObjectName("labelExperiencia")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_datosProfesion.setText(_translate("mainWindow", "Datos Profesión"))
        ...
        self.labelExperiencia.setText(_translate("mainWindow", "Experiencia"))
